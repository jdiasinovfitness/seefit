...
exports.processAPIError = exports.ServerError = exports.ConflictError = exports.NotFoundError = exports.ForbiddenError = exports.UnauthorizedError = exports.UnauthorizedResourceError = exports.RequestError = exports.HTTPClientError = void 0;
...
exports.processAPIError = function (err) {
    ...
    if (axios_1["default"].isAxiosError(err) && err.response) {
        if (err.response.status == 401) {
            ...
            return new ConflictError(((_b = (_a = err.response.data) === null || _a === void 0 ? void 0 : _a.error) === null || _b === void 0 ? void 0 : _b.resource) || "Undefined", ((_d = (_c = err.response.data) === null || _c === void 0 ? void 0 : _c.error) === null || _d === void 0 ? void 0 : _d.value) || "Undefined");
        }
        else if (err.response.status == 400) {
            return new RequestError(((_f = (_e = err.response.data) === null || _e === void 0 ? void 0 : _e.error) === null || _f === void 0 ? void 0 : _f.message) || "Undefined");
        }
        else {
