...
- **core** is placed inside the root of the **_app_** folder. Here you have two required subfolders: **services** & **components**
...
Run this command in **_web_** directory always before a push/commit. We want all the source organized and clean. Our default formatter is the **_prettier_**
